    ...
    *,
    ...
    for model_index, model_row in enumerate(model_rows):
        ...
        profile_row = {
            ...
            "model_kind": _model_value(row, model_row, "model_kind", default="text"),
            "image_capabilities": _model_value(row, model_row, "image_capabilities", default={}),
            "image_probe_status": _model_value(row, model_row, "image_probe_status", default="not_run"),
...
def _model_value(
    ...
    *,
    ...
    aliases = {
        ...
        "model_kind": ("model_kind", "modelKind", "modality", "model_modality"),
