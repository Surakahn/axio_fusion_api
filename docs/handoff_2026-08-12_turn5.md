...
## 追加: axio-terra vs terra 8题基准

| 模型 | 得分 | 延迟 | 502 |
|------|------|------|-----|
| axio-terra | 7/8 (88%) | 8.4s | 1 |
| gpt-5.6-terra | 7/8 (88%) | 3.2s | 1 |

502同时命中两个模型同一题 → CPA间歇故障。axio-terra累计: 45/51 (88%)
...
- ✅ Claude渠道: 完成(100%准确率)
- ✅ 图片模块: 完成
- ⚠️ 完整基准: 51题~88%, 需CPA稳定后继续
- ⚠️ 外部排名: 缺失
- ⚠️ axio-pro: CPA限流阻塞

### 下一步
1. CPA稳定性修复（重试/退避/多key轮换）
2. axio-pro稳定化后评测
3. 外部排名源搜索
